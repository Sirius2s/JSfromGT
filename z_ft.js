                        ...
                        for (let item of data.data.feedList) {
                            ...
                            if (item.skuTitle && $.isPush) {
                                ...
                                if (args_xh.whiteList) {
                                    if ((args_xh.whiteListKeywords.some(fileter_word => item.skuTitle.includes(fileter_word))) && (parseFloat(item.jdPrice) >= 30)) {
