            ...
            if (vo.ext.extraType !== 'brandMemberList' && vo.ext.extraType !== 'assistTaskDetail') {
                if (vo.completionCnt < vo.assignmentTimesLimit) {
                    ...
                    if (vo.ext) {
                        ...
                        if (vo.ext.productsInfo === null || vo.ext.productsInfo === undefined) {
                            vi = []
                        }
                        else{
                        ...
                        if (vo.ext.shoppingActivity === null || vo.ext.shoppingActivity === undefined) {
                            vi = []
                        }
                        else{
                        ...
                        if (vo.ext.browseShop === null || vo.ext.browseShop === undefined) {
                            vi = []
                        }
                        else{
                        ...
                        if (vo.ext.addCart === null || vo.ext.addCart === undefined) {
                            vi = []
                        }
                        else{
